...
```
https://heimahr-t.itheima.net/

https://heimahr-t.itheima.net/prod-api/sys/login
```
...
- 拉取命令
```bash
$ git clone  https://gitee.com/panjiachen/vue-admin-template.git  heimahr

下面是别人作者原始发布的github上地址，因为国外网络不通畅问题，
所以在码云上也存了一份，我们一般从码云上clone下来。就是上面地址
